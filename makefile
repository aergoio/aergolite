...
plugin-mini-raft.o: plugins/mini-raft/mini-raft.c plugins/mini-raft/mini-raft.h plugins/mini-raft/state_update.c plugins/mini-raft/transactions.c plugins/mini-raft/consensus.c common/sha256.c common/sha256.h plugins/common/uv_functions.c plugins/common/uv_msg_framing.c plugins/common/uv_msg_framing.h plugins/common/uv_send_message.c plugins/common/uv_callback.c plugins/common/uv_callback.h
	$(CC) $(LIBFLAGS) -c $< -o $@
